...
<title>LittyWatch V3.0 Item Encyclopedia</title>
<style>
...
<header class="top"><div><div class="eyebrow">LITTYWATCH V3.0</div><h1>Item Encyclopedia</h1><div class="muted">Marktdata gecombineerd met lokale marktdata en originele Gw.dat-iconen.</div></div><nav><a href="/v2-hub.php">Command Center</a><a href="/v2-markets.php">Markten</a><a href="/v2.php">Dashboard</a><a href="/v3-assets.php">Assets</a></nav></header>
<section class="stats">
