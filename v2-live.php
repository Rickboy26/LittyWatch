...
require __DIR__ . '/app/V2/Alerts/LiveFeedService.php';
...
<title>LittyWatch V2.5 Live Feed</title>
<style>
...
<header class="top"><div><div class="eyebrow">LITTYWATCH V2.5</div><h1>Live Market Feed</h1><div class="muted">De pagina haalt iedere 20 seconden de nieuwste opgeslagen offers op.</div></div><nav><a href="/v2-alerts.php">Alerts</a><a href="/v2-markets.php">Markten</a><a href="/v2.php">Dashboard</a></nav></header>
...
async function reloadFeed(){
 if(paused)return;
 try{
   const response=await fetch('/api/v2-live.php?limit=120',{cache:'no-store'});
