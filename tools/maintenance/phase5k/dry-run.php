...
function norm5k(string $v):string{
...
$patterns=[
    ...
    ['/\\bg-?zcoins?\\b/iu','Gold Zaishen Coin'],
    ...
    ['/\\bzaishen strat box\\b/iu',"Strategist's Zaishen Strongbox"],
    ['/\\bbday cake\\b/iu','Birthday Cupcake'],
    ['/\\bids\\b/iu','Icy Dragon Sword'],
    ['/\\bflames? normal\\b/iu','Flame of Balthazar'],
];
