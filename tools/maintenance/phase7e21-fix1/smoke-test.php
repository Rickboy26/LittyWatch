...
check21($loaded, 'guard class laadbaar');

$writer = file_get_contents($root . '/app/Market/StructuredOfferWriter.php');
check21(
    str_contains((string)$writer, 'LITTYWATCH_PHASE7E21_ACCEPTED_SAFETY'),
    'writer marker aanwezig'
);
...
if ($loaded) {
    ...
    $cases = [
        [
            [
                'item' => 'Spawning Staff',
                'item_key' => 'spawning-staff',
                'raw_segment' => 'Scepter q13 spaw',
        ...
        [
            [
                'item' => 'Paragon Rune of Superior Leadership',
                'item_key' => 'paragon-rune-of-superior-leadership',
                'raw_segment' => 'Q5 Strength/Leadership Shie',
                'quality_status' => 'accepted',
                'quality_reason' => 'catalog_match',
                'confidence' => 0.90,
            ],
        ...
        [
            [
                'item' => 'Split Chakrams of the Forgotten',
                'item_key' => 'split-chakrams-of-the-forgotten',
                'raw_segment' => 'Wand q9 of Forgotten',
                'quality_status' => 'accepted',
                'quality_reason' => 'catalog_match',
                'confidence' => 0.86,
            ],
        ...
        [
            [
                'item' => 'Eternal Shield',
                'item_key' => 'eternal-shield',
                'raw_segment' => 'eternal shield q10 comm 30e',
                'attribute_key' => 'communing',
                'quality_status' => 'accepted',
                'quality_reason' => 'catalog_match',
                'confidence' => 0.92,
            ],
    ...
    $fds = $g->repair([
        'item' => 'Fiery',
        'item_key' => 'fiery',
        'raw_segment' => 'Fiery drag sword q9 ins',
    ...
    check21(
        ($fds['item_key'] ?? '') === 'fiery-dragon-sword',
        'Fiery drag sword => Fiery Dragon Sword',
        $fds['item_key'] ?? null
    );
}
...
if ($fail) {
    echo "Phase 7E.21 FIX1 smoke-test: {$fail} fout(en)." . PHP_EOL;
    exit(1);
}

echo "Phase 7E.21 FIX1 smoke-test volledig OK." . PHP_EOL;
