...
<tr><td><a class="itemlink" href="/trader?name=<?=rawurlencode((string)$r['player'])?>"><?=h($r['player'])?></a></td><td><?=h($r['message'])?></td><td><span class="parse-status <?=h($status)?>"><?=h($r['parser_summary']?:'Nog niet geanalyseerd')?></span></td><td class="muted"><?=h($r['posted_at'])?></td></tr>
