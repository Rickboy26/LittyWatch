...
use LittyWatch\Knowledge\GwMarketCatalogImporter;
use PDO;
use Throwable;

final class KnowledgeController
{
    public function __construct(private readonly KnowledgeControllerData $data, private readonly View $view, private readonly PDO $pdo) {}
    ...
    public function importGwMarket(Request $request): Response
    {
        try {
            ...
            $result=(new GwMarketCatalogImporter($this->pdo))->import($category,$json);
