                ...
                foreach (array_values(array_unique($variants)) as $variant) {
                    ...
                    while (($pos = mb_stripos($lower, $aliasLower, $offset)) !== false) {
                        ...
                        $matches[] = [
                            ...
                            'market_quote_basis' => $item['market_quote_basis'] ?? ($item['market_price_basis'] ?? ''),
                            'market_quote_size' => $item['market_quote_size'] ?? ($item['market_stack_size'] ?? null),
                            'market_display_basis' => $item['market_display_basis'] ?? 'each',
                            'start' => $pos,
