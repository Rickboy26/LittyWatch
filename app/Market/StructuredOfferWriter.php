...
use LittyWatch\Parser\ParsedOffer; use LittyWatch\Parser\ParserEngine; use LittyWatch\AI\AiValidationRepository; use PDO;
final class StructuredOfferWriter {
 public function __construct(private readonly PDO $pdo,private readonly ParserEngine $parser,private readonly ?VariantNormalizer $normalizer=null,private readonly ?OfferLifecycleService $lifecycle=null,private readonly bool $queueAi=true){}
