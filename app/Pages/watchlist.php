...
<title>LittyWatch Watchlist</title>
...
<header class="top"><div><div class="eyebrow">LITTYWATCH</div><h1>Watchlist & koersdoelen</h1><div class="muted">Volg marktvarianten en maak automatisch een alert wanneer jouw koop- of verkoopdoel wordt geraakt.</div></div><nav><a href="/">Command Center</a><a href="/markets">Markten</a><a href="/alerts">Alerts</a><a class="lw-nav-health" href="/system">Systeem</a></nav></header>
...
?>
<div class="row">
<div><a class="market-link" href="/market?key=<?= rawurlencode((string)$row['market_key']) ?>"><strong><?= h($row['label']) ?></strong><span class="muted"><?= h($row['market_key']) ?></span></a><div class="muted">Laatste activiteit: <?= h($row['last_activity'] ?? '—') ?></div></div>
