...
<title>LittyWatch Traders</title>
<style>
...
<main class="wrap">
<header class="top">
<div><div class="eyebrow">LITTYWATCH</div><h1>Trader Intelligence</h1><div class="muted">Activiteit en handelsgedrag op basis van publieke Kamadan-advertenties.</div></div>
<nav><a href="/">Dashboard</a><a href="/markets">Markten</a><a href="/intelligence">Intelligence</a><a href="/watchlist">Watchlist</a></nav>
</header>
...
<a class="row" href="/trader?player=<?= rawurlencode((string)$row['player']) ?>">
