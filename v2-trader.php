...
<nav><a href="/v2-traders.php">Alle traders</a><a href="/v2-markets.php">Markten</a><a href="/v2.php">Dashboard</a></nav>
</header>
...
<a class="market" href="/v2-market.php?key=<?= rawurlencode((string)$row['market_key']) ?>">
...
<a class="offer" href="/v2-market.php?key=<?= rawurlencode((string)$row['market_key']) ?>">
