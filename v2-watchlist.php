...
<title>LittyWatch V2.8 Watchlist</title>
<style>
...
<header class="top"><div><div class="eyebrow">LITTYWATCH V2.8</div><h1>Watchlist & koersdoelen</h1><div class="muted">Volg marktvarianten en maak automatisch een alert wanneer jouw koop- of verkoopdoel wordt geraakt.</div></div><nav><a href="/v2-hub.php">Command Center</a><a href="/v2-markets.php">Markten</a><a href="/v2-alerts.php">Alerts</a></nav></header>
