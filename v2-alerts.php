...
?>
<!doctype html><html lang="nl"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>LittyWatch V2.9 Alerts</title>
...
<header class="top"><div><div class="eyebrow">LITTYWATCH V2.9</div><h1>Prijsalerts <span class="badge <?= $unread > 0 ? 'met' : 'off' ?>"><?= $unread ?> ongelezen</span></h1><div class="muted">Alerts gaan alleen af wanneer een conditie nieuw wordt geraakt of nieuwe marktactiviteit verschijnt.</div></div><nav><a href="/v2-watchlist.php">Watchlist</a><a href="/v2-markets.php">Markten</a><a href="/v2-hub.php">Command Center</a><a class="lw-nav-health" href="/v2-health.php">Systeem</a></nav></header>
